...
The increase in `ttl-num-blocks` from 5 to 12 is necessary to maintain consistent mempool behavior with the new block time. This adjustment ensures that transactions remain in the mempool for approximately 72 seconds (12 blocks × 6 seconds), maintaining similar duration to the previous behavior of about 60 seconds (5 blocks × 12 seconds).
